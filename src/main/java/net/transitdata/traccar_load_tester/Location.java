...
// This is a modified version of the Location Class to run under java without the Android SDK. It is intended for testing only.  
// Android dependencies, specifically Bundle and Parcel type objects and their declarations and references have been removed
...
public class Location {
    ...
    public Location(long mTime, double mLatitude, double mLongitude,
			double mAltitude, float mSpeed, float mBearing) {
		super();
		this.mTime = mTime;
